...
The architecture diagram or flow graph, which outlines the the model process from data pre-processing to the result analysis is shown in figure \ref{fig:workflow_pipeline}
